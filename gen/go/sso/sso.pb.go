...
var file_sso_sso_proto_rawDesc = string([]byte{
	...
	0x07, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x22, 0x29, 0x0a, 0x0e, 0x49, 0x73, 0x41, 0x64,
	...
	0x6b, 0x65, 0x6e, 0x32, 0xbd, 0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x3f, 0x0a, 0x08,
	...
	0x6e, 0x73, 0x65, 0x42, 0x0f, 0x5a, 0x0d, 0x62, 0x61, 0x62, 0x69, 0x6c, 0x6f, 0x2f, 0x73, 0x73,
...
var file_sso_sso_proto_depIdxs = []int32{
	2, // 0: auth.v1.Auth.Register:input_type -> auth.v1.RegisterRequest
	4, // 1: auth.v1.Auth.Login:input_type -> auth.v1.LoginRequest
	0, // 2: auth.v1.Auth.IsAdmin:input_type -> auth.v1.IsAdminRequest
	3, // 3: auth.v1.Auth.Register:output_type -> auth.v1.RegisterResponse
	5, // 4: auth.v1.Auth.Login:output_type -> auth.v1.LoginResponse
	1, // 5: auth.v1.Auth.IsAdmin:output_type -> auth.v1.IsAdminResponse
